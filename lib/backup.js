...
const BACKUP_TABLES = [
  ...
  "notifications",
  "analytics_events",
  // Referenced by server.js and redditRadar.js but absent from this list until
  // now — the same gap that left notifications and analytics_events unbacked.
  // moderation_logs is the one that matters most here: it is the only stored
  // evidence of who banned whom and why, and it is append-only, so a lost row
